...
const Hero = () => {
  return (
    <div className="relative w-full flex flex-col bg-linear-to-b from-primary-dark via-primary to-primary-deep py-5 md:py-10 lg:py-16 xl:py-20 px-3 md:px-4 lg:px-6 overflow-hidden shadow-[0_20px_50px_rgba(2,15,10,0.4)] z-20">
      <div className="hidden md:flex absolute md:bottom-0 lg:top-0 right-0 pointer-events-none select-none w-[60vw] h-[60vh] md:w-[35vw] md:h-[65vh] lg:w-[30vw] lg:h-[80vh] xl:w-[35vw] xl:h-screen z-0">
        <div className="absolute inset-0 bg-radial-gradient from-gold-accent/5 to-transparent opacity-50" />
        <Image
          src="/hero_logo.png"
          alt="Людмила Кирилюк"
          fill
      ...
      <div className="relative z-10 flex flex-1 flex-col gap-3 md:gap-5 lg:gap-8 xl:gap-10 px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 xl:gap-12 max-w-[90%] md:max-w-[70%] lg:max-w-[80%]">
          <div className="flex flex-col gap-2">
            <h1 className="text-foreground/90 text-base md:text-2xl lg:text-4xl xl:text-5xl font-black uppercase leading-[1.1]">
              РЕКЛАМА В ІНТЕРНЕТІ ДЛЯ ВАШОГО БІЗНЕСУ:
            </h1>
            <div className="min-h-[1.2em] text-[10px] sm:text-xs md:text-xl lg:text-2xl xl:text-4xl font-black uppercase leading-[1.1]">
              <Typewriter />
            </div>
          </div>

          <div className="flex flex-col gap-3 md:gap-4 lg:gap-5 xl:gap-6">
            <h2 className="text-foreground/80 font-medium text-xs md:text-sm lg:text-base max-w-xl border-l-2 border-gold-accent pl-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full bg-primary-dark/40 backdrop-blur-md border border-white/5 rounded-xl p-2 sm:p-3 md:p-4 lg:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
