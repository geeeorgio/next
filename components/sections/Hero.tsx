...
const Hero = () => {
  return (
    <div className="relative w-full flex flex-col bg-linear-to-b from-primary-dark via-primary to-primary-deep py-5 md:py-10 lg:py-16 xl:py-20 px-3 md:px-4 lg:px-6 overflow-hidden">
      ...
      <div className="relative z-10 flex flex-1 flex-col gap-3 md:gap-5 lg:gap-8 xl:gap-10 px-3 md:px-4 lg:px-6 xl:px-8">
        <div className="flex flex-col gap-6 md:gap-8 lg:gap-10 xl:gap-12 max-w-[90%] md:max-w-[70%] lg:max-w-[60%]">
          <div className="flex flex-col gap-2">
            ...
            <div className="min-h-[1.2em] text-xs md:text-2xl xl:text-4xl font-black uppercase leading-[1.1]">
              <Typewriter />
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-row gap-2 lg:gap-3 w-full bg-primary-dark/60 border border-foreground-muted/25 rounded-2xl p-2 lg:p-6">
