          ...
          {servicesList.map(({ label_ua, desc, icon: Icon }) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 gap-4 lg:gap-5 xl:gap-6">
                <div className="flex items-center justify-center w-14 h-14 rounded-2xl border border-gold-accent/20 bg-primary-deep text-gold-accent transition-all duration-500 group-hover:border-gold-accent/40 group-hover:shadow-[0_0_20px_rgba(244,216,143,0.12)]">
                  <Icon
                    size={28}
                ...
                <div className="flex flex-col gap-4 md:gap-5 lg:gap-6 xl:gap-7">
                  <p className="text-gold-middle-accent text-base lg:text-xl font-bold tracking-wide leading-snug">
                    {label_ua}
                  </p>
