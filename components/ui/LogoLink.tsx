...
const LogoLink = () => {
  return (
    ...
    >
      <div className="absolute inset-0 rounded-full bg-gold-accent/5 blur-xl opacity-20 transition-opacity duration-700 group-hover:opacity-100 group-hover:bg-gold-accent/10" />
