...
const ServicesLink = ({ src, text }: ServicesLinkProps) => {
  return (
    ...
    >
      <div className="absolute inset-y-0 left-0 w-0 bg-linear-to-r from-gold-accent-sand via-gold-middle-accent/85 to-gold-accent/70 transition-[width] duration-500 ease-learn-more group-hover:w-[50%]" />

      <div className="absolute inset-y-0 right-0 w-0 bg-linear-to-l from-gold-accent-sand via-gold-middle-accent/85 to-gold-accent/70 transition-[width] duration-500 ease-learn-more group-hover:w-[50%]" />
