...
const DetailsLink = ({ src, text }: DetailsLinkProps) => {
  return (
    <Link
      href={src}
      className="group relative inline-flex self-center items-center gap-4 lg:gap-5 py-3 px-3 active:scale-95"
    >
      <div className="absolute inset-y-0 left-0 w-11 rounded-full border border-gold-middle-accent/45 bg-primary-section/80 transition-all duration-500 ease-learn-more group-hover:w-full group-hover:bg-gold-accent" />
