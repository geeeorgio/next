...
const DetailsLink = ({ src, text }: DetailsLinkProps) => {
  return (
    ...
    >
      <div className="absolute inset-y-0 left-0 w-11 rounded-full border border-gold-middle-accent/45 bg-primary-deep transition-all duration-500 ease-learn-more group-hover:w-full group-hover:bg-gold-middle-accent group-hover:border-gold-middle-accent" />
