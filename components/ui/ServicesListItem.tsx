...
const ServicesListItem = ({ item: { label_ua, icon: Icon, desc } }: ServicesListItemProps) => {
  return (
    <li className="group relative overflow-hidden flex flex-col flex-1 rounded-2xl bg-card-light border border-foreground-muted/10 shadow-[0_8px_30px_-10px_rgba(40,32,15,0.2),0_4px_10px_-4px_rgba(2,15,10,0.1)] gap-4 md:gap-5 lg:gap-6 xl:gap-7 p-5 lg:p-7 transition-all duration-700 ease-learn-more hover:border-gold-middle-accent/30 hover:shadow-[0_25px_50px_-12px_rgba(180,142,50,0.2),0_10px_20px_-5px_rgba(2,15,10,0.1)]">
