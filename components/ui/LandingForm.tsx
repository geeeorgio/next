  ...
  return (
    <div className="flex flex-col w-full">
      <form
        ...
        id="landing_form"
        className="flex flex-col gap-5 md:gap-6 xl:gap-7 rounded-2xl bg-form p-4 sm:p-6 lg:p-8 shadow-2xl border border-white/5"
      >
        ...
        <button
          ...
          className="
            ...
            transition-all duration-500 hover:border-gold-accent hover:shadow-[0_0_20px_rgba(244,216,143,0.15)]
